...
async def ball(context , *,inp ):
    if inp =="Are you gay" or inp == "are you gay":
        nou=discord.Embed(title="8Ball",color=0xFFA200)
        ...
        nou.set_footer(text="8Ball, The future is predictable", icon_url="http://www.clker.com/cliparts/w/L/F/v/7/8/sparkle-md.png")
        ...
        reply=discord.Embed(title="8Ball",color=0xFFA200)
        ...
        reply.set_footer(text="8Ball, The future is predictable", icon_url="http://www.clker.com/cliparts/w/L/F/v/7/8/sparkle-md.png")
        await client.say(context.message.author.mention)
...
async def urban(ctx,*,word):
    try:
        ...
        out.set_footer(text="Urban Dictionary, " + ctx.message.author.name , icon_url='https://vignette.wikia.nocookie.net/logopedia/images/a/a7/UDAppIcon.jpg/revision/latest?cb=20170422211150')
        out.set_thumbnail(url='https://s3.amazonaws.com/pushbullet-uploads/ujxPklLhvyK-RGDsDKNxGPDh29VWVd5iJOh8hkiBTRyC/urban_dictionary.jpg?w=188&h=188&fit=crop')
        await client.send_message(ctx.message.channel, embed=out)
    except Exception as e:
        await client.say("Something Went Wrong, Theres Probably No Definition For This Word On Urban Dictionary, " + ctx.message.author.mention)
    await client.delete_message(ctx.message)
...
@client.command(pass_context=True)
async def sing(ctx):
    song=("We're no strangers to love You know the rules and so do I A full commitment's what I'm thinking of You wouldn't get this from any other guy I just wanna tell you how I'm feeling Gotta make you understand Never gonna give you up Never gonna let you down Never gonna run around and desert you Never gonna make you cry Never gonna say goodbye Never gonna tell a lie and hurt you We've known each other for so long Your heart's been aching, but You're too shy to say it Inside, we both know what's been going on We know the game and we're gonna play it And if you ask me how I'm feeling Don't tell me you're too blind to see Never gonna give you up Never gonna let you down Never gonna run around and desert you Never gonna make you cry Never gonna say goodbye Never gonna tell a lie and hurt you Never gonna give you up Never gonna let you down Never gonna run around and desert you Never gonna make you cry Never gonna say goodbye Never gonna tell a lie and hurt you (Ooh, give you up) (Ooh, give you up) Never gonna give, never gonna give (Give you up) Never gonna give, never gonna give (Give you up) We've known each other for so long Your heart's been aching, but You're too shy to say it Inside, we both know what's been going on We know the game and we're gonna play it I just wanna tell you how I'm feeling Gotta make you understand Never gonna give you up Never gonna let you down Never gonna run around and desert you Never gonna make you cry Never gonna say goodbye Never gonna tell a lie and hurt you Never gonna give you up Never gonna let you down Never gonna run around and desert you Never gonna make you cry Never gonna say goodbye Never gonna tell a lie and hurt you Never gonna give you up Never gonna let you down Never gonna run around and desert you Never gonna make you cry Never gonna say goodbye Never gonna tell a lie and hurt you")
    my_var =song.split()
...
@client.command(pass_context=True,description="Only Works in Dunder Mifflin Server",brief="Only Works in Dunder Mifflin Server")
async def ping(ctx):
    if str(ctx.message.server)== "Dunder Mifflin":
        result=[" is a korean boy loving ass" , " is a lolifurry" , " likes boy semen" , " likes dem wrickled tits" , " likes there brothers rod" , " IS A DOUCHEBAGGETE" ," im jealous of everyone who HASN'T MET YOU" , " IS A DOGGYKNOBBER" , " licks his mothers minge"]
        mentions=["<@265851383692001280>", "<@277129203592331264>","<@241305141624438784>", "<@280443982864056320>","<@149452733215277056>" , "<@174244883970654208>","<@133028189243965440>","<@107426138988482560>"]
        await client.say(random.choice(mentions) + random.choice(result))

@client.command(pass_context=True)
async def invite(ctx):
    await client.say("INVITE MY GAY ASS WITH THIS URL" + " " + "https://discordapp.com/oauth2/authorize?client_id=420882476748242944&scope=bot&permissions=939979967" + " , " + ctx.message.author.mention)
    await client.delete_message(ctx.message)
...
async def splash(ctx,*,champion):
    ...
    if str(q) == "<Response [200]>":
        embed=discord.Embed(title=champion,description="{}'s Splash Art".format(champion),color=0x003366)
        embed.set_image(url=imgurl)
        embed.set_footer(text="League of Legends" , icon_url="https://vignette.wikia.nocookie.net/leagueoflegends/images/1/12/League_of_Legends_Icon.png/revision/latest?cb=20150402234343")
        await client.say(embed=embed)
    else:
...
async def info(ctx,*,member:discord.Member=None):
    ...
    embed=discord.Embed(title="{}'s Info:".format(member.name),description="Here's What I Could Find:",color=0xFF66BE)
